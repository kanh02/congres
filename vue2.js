var app = new Vue({
	...
	methods: {
		...
		sortVotes: function () {
			...
			return app.sortedMembers.sort(function (a, b) {
		...
		sortVotesInv: function (members) {
			...
			return app.sortedMembersInverse.sort(function (a, b) {
